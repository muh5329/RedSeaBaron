...
func _ready() -> void:
	...
	add_child(rider)
	rider.pose_riding()
	rider_aim_point = Marker3D.new()
	rider_aim_point.name = "RiderAimPoint"
	rider_aim_point.position.y = 0.45
	rider.torso.add_child(rider_aim_point)
	rider.visible = false
