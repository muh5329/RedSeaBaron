...
func _environment() -> void:
	...
	ocean.size = sea.bounds.size
	var sea_center := sea.bounds.get_center()
	var water := BlockoutKit.mesh(self, ocean, Vector3(sea_center.x,sea.level,sea_center.y), Color("367e88"))
