...
static func clear_line(world: World3D, a: Vector3, b: Vector3) -> bool:
	return world.direct_space_state.intersect_ray(PhysicsRayQueryParameters3D.create(a, b, 1)).is_empty()
