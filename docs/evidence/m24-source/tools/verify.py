...
parser.add_argument('--suites', default='traversal,combat,bike,flight,cart,logistics,worker,world,save,ui,integration,feedback,ai,economy,highland,region,recovery,encounter,routine,routine_stop,backdrop,routes,airmail,cargo_access')
...
minimum = dict(traversal=21, combat=34, bike=26, flight=22, cart=25, logistics=23, worker=25, world=15, distance=6, save=22, ui=14, integration=16, feedback=9, ai=10, economy=21, highland=8, region=18, recovery=8, encounter=16, routine=16, routine_stop=4, backdrop=7, routes=16, airmail=12, cargo_access=11)
for suite in suites:
