...
rate=22050
for name,duration in [('rifle',.28),('swing',.16),('hit',.2),('reload',.18),('step',.055),('jump',.16),('reward',.6),('engine',.6)]:
    pcm=[]
    for i in range(int(rate*duration)):
        ...
        else: value=(math.sin(t*2*math.pi*80)+.3*math.sin(t*2*math.pi*160)+.12*math.sin(t*2*math.pi*240))*.3
