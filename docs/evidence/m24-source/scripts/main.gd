...
const EncounterVerifier = preload("res://tests/encounter_verifier.gd")
const RoutineVerifier = preload("res://tests/routine_verifier.gd")
const RoutineStopVerifier = preload("res://tests/routine_stop_verifier.gd")
const CargoAccessVerifier = preload("res://tests/cargo_access_verifier.gd")
const RoutesVerifier = preload("res://tests/routes_verifier.gd")
const AirmailVerifier = preload("res://tests/airmail_verifier.gd")
const BackdropVerifier = preload("res://tests/backdrop_verifier.gd")
...
func run_encounter_verifier() -> void:
	await _run_suite(EncounterVerifier)

func run_routine_verifier() -> void:
	await _run_suite(RoutineVerifier)

func run_routine_stop_verifier() -> void:
	await _run_suite(RoutineStopVerifier)

func run_backdrop_verifier() -> void:
	await _run_suite(BackdropVerifier)

func run_routes_verifier() -> void:
	await _run_suite(RoutesVerifier)

func run_airmail_verifier() -> void:
	await _run_suite(AirmailVerifier)

func run_cargo_access_verifier() -> void:
	await _run_suite(CargoAccessVerifier)
