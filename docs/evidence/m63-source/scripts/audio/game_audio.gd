...
extends Node3D
const CLIPS := {"rifle":preload("res://assets/sfx/rifle.wav"),"swing":preload("res://assets/sfx/swing.wav"),"hit":preload("res://assets/sfx/hit.wav"),"reload":preload("res://assets/sfx/reload.wav"),"step":preload("res://assets/sfx/step.wav"),"jump":preload("res://assets/sfx/jump.wav"),"reward":preload("res://assets/sfx/reward.wav")}
var game: Node3D
