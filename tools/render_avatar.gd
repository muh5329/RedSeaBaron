...
var prefix: String = "avatar-current"
func _initialize() -> void:
	for argument in OS.get_cmdline_user_args():
		if argument.begins_with("--prefix="): prefix=argument.trim_prefix("--prefix=")
